...
XAMPP.
 ...
 3. Download [jQuery](https://cdnjs.cloudflare.com/ajax/libs/jquery/3.6.0/jquery.min.js) and [clipboard.js](https://cdnjs.cloudflare.com/ajax/libs/clipboard.js/2.0.8/clipboard.min.js) and place them in `.\htdocs\malibu\isbn`
